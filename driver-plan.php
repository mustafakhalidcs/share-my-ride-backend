...
if($_POST["command"]=="postplan"){
	...
	$sql = "INSERT INTO `plan`(`plan_id`, `email`, `destination`, `current_location`, `route`, `departure_date`, `modified_date`, `departure_time`, `smoker`, `music_lover`)
	 VALUES ('','$email','$destination','$current_location','$route','$departure_date','','$departure_time','$smoker','$music_listener')";
